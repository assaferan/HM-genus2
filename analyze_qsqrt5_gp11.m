// analyze_qsqrt5_gp11.m -- Per-survivor analysis for the (1,11) search over Q(sqrt(5)).
// Reads survivors_qsqrt5_gp11.m (from search_qsqrt5_gp11.m -- no re-inversion)
...
//
// Note: 11 SPLITS in Q(sqrt(5)), so there are two primes above 11; we report Frobenius
// at the first one. Both should have a root in F_11 (rational 11-isogeny).
//
// Run: magma analyze_qsqrt5_gp11.m
...
p11 := PrimesAbove(k, 11)[1];   // first prime above 11 (norm 11, since 11 splits)
