// Example / smoke test for the quadratic-field pipeline: generate a genus-2 curve
// over Q(sqrt2) from x = [1, sqrt2, 3, 4].
//
// Run:  magma test_quadratic.m
...
C, QI := Genus2CurveQuadratic(x, k);     // EmbSign := 1, i.e. sqrt2 -> +1.41421...
